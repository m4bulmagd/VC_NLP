...
document.getElementById('lowercase').addEventListener('click', function(e) {
  e.preventDefault();
  tags.addTags('lowercase');
});

document.getElementById('remove_special_characters').addEventListener('click', function(e) {
  e.preventDefault();
  tags.addTags('remove_special_characters');
});

document.getElementById('removeStops').addEventListener('click', function(e) {
  e.preventDefault();
  tags.addTags('removeStops');
});

document.getElementById('case_folding').addEventListener('click', function(e) {
  e.preventDefault();
  tags.addTags('case_folding');
});

document.getElementById('text_lemmatization').addEventListener('click', function(e) {
  e.preventDefault();
  tags.addTags('text_lemmatization');
});

document.getElementById('text_stemming').addEventListener('click', function(e) {
  e.preventDefault();
  tags.addTags('text_stemming');
});


document.getElementById('addArr').addEventListener('click', function(e) {
  e.preventDefault();
  tags.addTags(['lowercase', 'remove_special_characters', 'removeStops' , 'case_folding' ,'text_lemmatization' ,'text_stemming' ]);
});


// Use
var tags2 = new Tags('.tagged2');
...
document.getElementById('lowercase2').addEventListener('click', function(e) {
  e.preventDefault();
  tags2.addTags('lowercase');
});

document.getElementById('remove_special_characters2').addEventListener('click', function(e) {
  e.preventDefault();
  tags2.addTags('remove_special_characters');
});

document.getElementById('removeStops2').addEventListener('click', function(e) {
  e.preventDefault();
  tags2.addTags('removeStops');
});

document.getElementById('case_folding2').addEventListener('click', function(e) {
  e.preventDefault();
  tags2.addTags('case_folding');
});

document.getElementById('text_lemmatization2').addEventListener('click', function(e) {
  e.preventDefault();
  tags2.addTags('text_lemmatization');
});

document.getElementById('text_stemming2').addEventListener('click', function(e) {
  e.preventDefault();
  tags2.addTags('text_stemming');
});


document.getElementById('addArr2').addEventListener('click', function(e) {
  e.preventDefault();
  tags2.addTags(['lowercase', 'remove_special_characters', 'removeStops' , 'case_folding' ,'text_lemmatization' ,'text_stemming' ]);
});
