...
def processing():
	...
	if request.method == 'POST':
		...
		files = request.files['files_input[]']
		print(files)
		if files:
			for file in files:
	...
	corpus_url = '/media/i933k/Data/code/projects/vc_nlp/corpus'
	...
	if not bool(new_tf2):
		return render_template('vis.html' ,  tf1 = new_tf1, tfidf1=new_tf1 ,  time1=time1 , single_chart = True)
